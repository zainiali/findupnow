                        ...
                        <div class="wsus__dashboard_content">
                            <div class="wsus_dashboard_body">
                                <div class="wsus__review_input">
                                    <div class="row py-1">
                                        <div class="col-md-12 d-flex align-items-center justify-content-between gap-3 py-1">
                                            <h3>{{ __('Edit Job Post') }}</h3>
                                            <a class="common_btn order_request_btn"
                                                href="{{ route('jobpost.index') }}">{{ __('Go Back') }}</a>
                                        </div>
                                    </div>
                                    <hr>
                                    <form action="{{ route('jobpost.update', $job_post->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <fieldset>
                                                    ...
                                                    <textarea class="summernote" id="description" name="description">{{ $job_post->description }}</textarea>
                                                </fieldset>
                                            </div>

                                            <div class="col-lg-6">
                                                <div class="dashboard-cehckbox">
                                                    <label>{{ __('Visibility Status') }} *</label>
                                                    <input name="status" type="hidden" value="disable">
                                                    <input name="status" type="checkbox" value="enable"
                                                        {{ $job_post->status == 'enable' ? 'checked' : '' }}>
                                                </div>
                                            </div>
