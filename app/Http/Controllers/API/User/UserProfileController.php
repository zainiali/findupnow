...
class UserProfileController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $orders = Order::orderBy('id', 'desc')->select('id', 'order_id', 'client_id', 'total_amount', 'booking_date', 'order_status')->where('client_id', $user->id)->get();
        ...
        $tickets = Ticket::with('user', 'order', 'unSeenUserMessage')->where('user_id', $user->id)->orderBy('id', 'desc')->paginate();
    ...
    {
        $ticket = Ticket::with('user', 'order')->where('ticket_id', $id)->firstOrFail();
