...
class ProviderOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('website.provider.order', compact('orders', 'title', 'currency_icon', 'decliened_booking', 'total_awaiting', 'active_booking', 'complete_booking'));
    }
    ...
    public function show($id)
    {
        ...
        return view('website.provider.show_order', compact('order', 'currency_icon', 'client', 'booking_address', 'package_features', 'additional_services', 'completeRequest'));
    }
