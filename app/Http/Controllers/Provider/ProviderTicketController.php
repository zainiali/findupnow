...
class ProviderTicketController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('website.provider.ticket', compact('tickets'));
    }
    ...
    public function show($id)
    {
        ...
        return view('website.provider.show_ticket', compact('ticket', 'messages'));
    }
    ...
    public function createNewTicket()
    {
        ...
        return view('website.provider.create_new_ticket', compact('orders'));
    }
