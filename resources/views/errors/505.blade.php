@php
    ...
    if ($selected_theme == 'theme_one') {
        $active_theme = 'website.layout';
    } elseif ($selected_theme == 'theme_two') {
        $active_theme = 'website.layout2';
    } elseif ($selected_theme == 'theme_three') {
        $active_theme = 'website.layout3';
    } else {
        $active_theme = 'website.layout';
    }
    $nav_menu = menuGetBySlug('main-menu');
@endphp
            ...
            <div class="row">
                <div class="col-xl-7 m-auto mb_40">
                    <div class="wsus__404_text">
                        ...
                        <a class="common_btn" href="{{ route('home') }}">{{ __('Go Back Home') }}</a>
                    </div>
                </div>
            </div>
        </div>
