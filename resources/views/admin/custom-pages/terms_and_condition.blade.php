                                ...
                                <ul class="lang_list">
                                    @foreach ($languages as $language)
                                        <li><a id="{{ request('code', $code) == $language->code ? 'selected-language' : '' }}"
                                                href="{{ route('admin.terms-and-condition.index', ['code' => $language->code]) }}"><i
                                ...
                                <form action="{{ route('admin.terms-and-condition.update', $termsAndCondition->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            ...
                                            <textarea class="summernote" name="terms_and_condition" cols="30" rows="10">{!! clean($termsAndCondition->getTranslation($code)?->terms_and_condition) !!}</textarea>
                                        </div>
