                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <select class="form-control select2" id="" name="provider_id">
                                                ...
                                                @foreach ($providers as $provider)
                                                    <option value="{{ $provider->id }}"
                                                        ...
                                                        {{ $provider->email }}</option>
                                                @endforeach
                                            </select>
                                        </div>

                                        <div class="form-group col-12">
                                            <label class="form-label">{{ __('Service Name') }} <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group col-12">
                                            <label class="form-label">{{ __('Details') }} <span
                                                    class="text-danger">*</span></label>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        @if ($service->approve_by_admin == 0)
                                            <div class="form-group col-12">
                                                <label class="form-label">{{ __('Provider Service Request') }}</label>
                                                <select class="form-control" id="" name="approved">
                                        ...
                                        @if ($service->approve_by_admin == 1)
                                            <div class="form-group col-12">
                                                <label class="form-label">{{ __('Make a Featured') }}</label>
                                                <select class="form-control" id="" name="featured">
                                                    <option value="1"
                                                        {{ $service->make_featured == 1 ? 'selected' : '' }}>
                                                        {{ __('Yes') }}</option>
                                                    <option value="0"
                                                        {{ $service->make_featured == 0 ? 'selected' : '' }}>
                                                        {{ __('No') }}</option>
                                                </select>
                                            </div>

                                            <div class="form-group col-12">
                                                <label class="form-label">{{ __('Make a Popular') }}</label>
                                                <select class="form-control" id="" name="popular">
                                                    <option value="1"
                                                        {{ $service->make_popular == 1 ? 'selected' : '' }}>
                                                        {{ __('Yes') }}</option>
                                                    <option value="0"
                                                        {{ $service->make_popular == 0 ? 'selected' : '' }}>
                                                        {{ __('No') }}</option>
                                                </select>
                                            </div>

                                            <div class="form-group col-12">
                                                <label class="form-label">{{ __('Want to banned ?') }}</label>
                                                <select class="form-control" id="" name="banned">
                                                    <option value="1"
                                                        {{ $service->is_banned == 1 ? 'selected' : '' }}>
                                                        {{ __('Yes') }}</option>
                                                    <option value="0"
                                                        {{ $service->is_banned == 0 ? 'selected' : '' }}>
                                                        {{ __('No') }}</option>
                                                </select>
                                            </div>
