    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <a class="btn btn-primary" href="{{ route('admin.partner.create') }}"><i class="fas fa-plus"></i>
                    {{ __('Add New') }}</a>
                <div class="row mt-4">
                    <div class="col">
                        <div class="card">
                                        ...
                                        <tbody>
                                            @foreach ($partners as $index => $partner)
                                                <tr>
                                                    ...
                                                    <td> <img class="w_80 img-thumbnail" src="{{ asset($partner->logo) }}"
                                                            alt="" width="50px" @style(['margin: 3px !important'])></td>
                                                    <td>
                                                        @if ($partner->status == 1)
                                                            <a href="javascript:;"
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary btn-sm"
                                                            href="{{ route('admin.partner.edit', $partner->id) }}"><i
